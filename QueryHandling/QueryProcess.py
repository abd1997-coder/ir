...
from indexer import get_irregular_verbs,get_Days_names,get_Months_names,get_stop_words,getCurrencies
...
StopWordsFile = '../Documents/common_words.txt'
datasetfile='../corpus/CISI/CISI.ALL'
...
def checkIfIrRegularOrShortcut(word):
    ...
    if irregularVerbsDict.__contains__(word):
     print('irregularVerbsDict:', word)
    if DaysOfTheWeek.__contains__(
        word) or MonthsNames.__contains__(word):
     print('date:', word)
     if Currencies.__contains__(word):
         print('cuurencies:', word)
...
if __name__ == '__main__':
     query= "gone Bear         to africa and >? Bidden laerned alot euro April go may playing played "

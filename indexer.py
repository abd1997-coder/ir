...
def save_index(path, data):
    try:
        ...
        return False
def save_index2(path, data):
    
    file = open(path, "w")
    s = pickle.dumps(data,file)
    #file.write(json.dumps(data))
    file.close()
    return True
...
if __name__ == '__main__':
    ...
    ngrams=build_ngrams(stemmedSentence)
    #save_index2('indexfiles/ngrams.json', ngrams)
    print(ngrams)
    #print(index)
